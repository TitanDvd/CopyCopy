    ...
    public class Win32_HddUtility
    {
        ...
        public static string GetVolumeSerialNumber(string volumeLetter)
        {
            ...
            if (Environment.OSVersion.Platform == PlatformID.Win32NT)
                ...
                handle = CreateFile($@"\\.\{volumeLetter}", GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, 0, OPEN_EXISTING, 0, 0);
            else // for win'9x
        ...
        public static string GetVolumeName(string volumeLetter)
        {
            return DriveInfo.GetDrives().FirstOrDefault(x => x.RootDirectory.Name == volumeLetter)?.VolumeLabel;
        }
    }
}
